...
volatile int pulseBase = 0;
volatile double posBase = 0, setBase = 0, outputBase = 0, lastoutputBase = 0;
volatile double E1 =0, E2 = 0, Ea = 0, alpha1 = 0, beta1 = 0, gama1 = 0, T = 0.01;
volatile double Kd1, Kp1, Ki1;
